...
const AddService = ({ handleNext, handleBack ,handleClose}) => {
  ...
  return (
    <>
      ...
      <div className="service-container-customize my-5">
        ...
        >
          <h2 className="login-head">Update service hours</h2>
          ...
          <div className="service-button-customize">
            ...
            <button onClick={handleClose} className="cancel-CustomizeService">Cancel</button>
          </div>
        </form>
      </div>
    </>
